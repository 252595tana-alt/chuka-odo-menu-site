...
- On the closing line and final visit CTA screens only, layer an original pointer-reactive ink-in-water graphic in oxblood, crimson, and vermilion behind the content. Keep a quiet dark area behind the white copy and jade CTA, provide a non-WebGL red-ink fallback, and freeze the graphic when reduced motion is requested; this scoped red treatment supersedes the general vermilion restriction for these two screens.
