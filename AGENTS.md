...
- On the closing line and final visit CTA screens, layer an original pointer-reactive ink-in-water graphic in imperial jade, celadon, and restrained amber-gold. Never use red or blood-like liquid color in this effect. Keep a quiet dark area behind the white copy and jade CTA, provide a matching non-WebGL fallback, and freeze the graphic when reduced motion is requested.
