...
export function App() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const norenProgress = clamp(progress / 0.18);
      const norenLead = easeInOutSine(norenProgress);
      const norenShoulder = delayedClothEase(norenProgress, 0.04);
      const norenFold = delayedClothEase(norenProgress, 0.1);
      const norenMid = delayedClothEase(norenProgress, 0.18);
      const norenLower = delayedClothEase(norenProgress, 0.28);
      const norenHem = delayedClothEase(norenProgress, 0.36);
      const norenRightLead = delayedClothEase(norenProgress, 0.06);
      const norenRightShoulder = delayedClothEase(norenProgress, 0.12);
      const norenRightFold = delayedClothEase(norenProgress, 0.2);
      const norenRightMid = delayedClothEase(norenProgress, 0.3);
      const norenRightHem = delayedClothEase(norenProgress, 0.4);
      const norenBillow = Math.sin(norenProgress * Math.PI);
      const norenOpacity = 1 - clamp((progress - 0.22) / 0.04);
      const heroExit = clamp((progress - 0.26) / 0.06);
      const heroFade = 1 - clamp((progress - 0.52) / 0.1);
      const orderIn = clamp((progress - 0.52) / 0.1);
      experience.style.setProperty("--page-progress", progress.toFixed(3));
      experience.style.setProperty("--noren-left-apex-y", `${(100 - norenLead * 78).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-apex-y", `${(100 - norenRightLead * 54).toFixed(2)}%`);
      experience.style.setProperty("--noren-left-shoulder-x", `${(50 - norenShoulder * 6).toFixed(2)}%`);
      experience.style.setProperty("--noren-left-shoulder-y", `${(100 - norenShoulder * 75).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-shoulder-x", `${(50 + norenRightShoulder * 6).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-shoulder-y", `${(100 - norenRightShoulder * 51).toFixed(2)}%`);
      experience.style.setProperty("--noren-left-fold-x", `${(50 - norenFold * 13).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-fold-x", `${(50 + norenRightFold * 14).toFixed(2)}%`);
      experience.style.setProperty("--noren-left-fold-y", `${(100 - norenFold * 68).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-fold-y", `${(100 - norenRightFold * 45).toFixed(2)}%`);
      experience.style.setProperty("--noren-left-mid-x", `${(50 - norenMid * 22).toFixed(2)}%`);
      experience.style.setProperty("--noren-left-mid-y", `${(100 - norenMid * 53).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-mid-x", `${(50 + norenRightMid * 24).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-mid-y", `${(100 - norenRightMid * 34).toFixed(2)}%`);
      experience.style.setProperty("--noren-left-lower-x", `${(50 - norenLower * 34).toFixed(2)}%`);
      experience.style.setProperty("--noren-left-lower-y", `${(100 - norenLower * 30).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-lower-x", `${(50 + norenRightHem * 33).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-lower-y", `${(100 - norenRightHem * 19).toFixed(2)}%`);
      experience.style.setProperty("--noren-left-hem-x", `${(50 - norenHem * 45).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-hem-x", `${(50 + norenRightHem * 42).toFixed(2)}%`);
      experience.style.setProperty("--noren-left-tilt", `${(norenLead * 8).toFixed(2)}deg`);
      experience.style.setProperty("--noren-right-tilt", `${(norenRightLead * -3.5).toFixed(2)}deg`);
      experience.style.setProperty("--noren-left-roll", `${(norenLead * -1).toFixed(2)}deg`);
      experience.style.setProperty("--noren-right-roll", `${(norenRightLead * 0.35).toFixed(2)}deg`);
      experience.style.setProperty("--noren-left-depth", `${(norenBillow * 26).toFixed(2)}px`);
      experience.style.setProperty("--noren-right-depth", `${(norenBillow * 16).toFixed(2)}px`);
      experience.style.setProperty("--noren-left-bend", `${(norenBillow * 1.5).toFixed(2)}deg`);
      experience.style.setProperty("--noren-right-bend", `${(norenBillow * -0.8).toFixed(2)}deg`);
      experience.style.setProperty("--noren-left-shift", `${(norenBillow * -0.7).toFixed(2)}%`);
      experience.style.setProperty("--noren-right-shift", `${(norenBillow * 0.4).toFixed(2)}%`);
      ...
      const nextPhase = progress < 0.57 ? "hero" : "order";
